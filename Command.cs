...
namespace TCPServer {
    ...
    public class Command {
        ...
        public event Action<string, Socket> Output;//输出事件
        public event Action<string, Socket> Error;//错误事件
        public event Action<Socket> Exited;//退出事件
        ...
        public void RunCMD(string cmd, Socket socket) {
            this.socket = socket;
            if (!_Run) {
